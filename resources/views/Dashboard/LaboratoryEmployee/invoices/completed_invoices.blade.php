                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td><a href="{{route('viewLaboratories_laboratory_employee',$invoice->id)}}">{{ $invoice->Patient->name }}</a></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{route('invoices_laboratory_employee.edit',$invoice->id)}}"><i class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp;{{ trans('Dashboard/DoctorDashboard/Invoices.add_diagnosis') }}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
