			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('invoices_ray_employee.index') }}">{{ trans('main-sidebar_trans.doctor_statements_list') }}</a></li>
							<li><a class="slide-item" href="{{ route('completedInvoices_ray_employee') }}">{{ trans('main-sidebar_trans.doctor_completed_statements') }}</a></li>
						</ul>
					</li>
