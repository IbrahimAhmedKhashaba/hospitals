    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ trans('Dashboard/DoctorDashboard/Invoices.add_review_for_a_patient') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group" style="position:relative;">
                    <label>{{ trans('Dashboard/Modals/Modal.review_date') }}</label>
