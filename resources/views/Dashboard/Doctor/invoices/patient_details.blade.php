        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('main-sidebar_trans.patients') }}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main-sidebar_trans.patient_details') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li class="nav-item"><a href="#tab1" class="nav-link active" data-toggle="tab">{{ trans('Dashboard/DoctorDashboard/Invoices.patient_record') }}</a></li>
                                            <li class="nav-item"><a href="#tab2" class="nav-link" data-toggle="tab">{{ trans('main-sidebar_trans.rays') }}</a></li>
                                            <li class="nav-item"><a href="#tab3" class="nav-link" data-toggle="tab">{{ trans('main-sidebar_trans.laboratories') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>{{ trans('Dashboard/Tables/Table.ray_employee_name') }}</th>
                                                       ...
                                                       {{-- <td>{{$patient_ray->employee_id !==null ? $patient_ray->employee->name:'NOEmployee'}}</td> --}}
                                                        <td>{{$patient_ray->employee->name ?? 'noEmployee'}}</td>
                                                            ...
                                                            @if($patient_ray->case == 0)
                                                                <td class="text-danger">{{ trans('Dashboard/Tables/Table.completed') }}</td>
                                                            @else
                                                                <td class="text-success">{{ trans('Dashboard/Tables/Table.not_completed') }}</td>
                                                            @endif
                                                    ...
                                                    @foreach($patient_laboratories as $patient_Laboratorie)
                                                        <tr>
                                                            ...
                                                            @if($patient_Laboratorie->doctor_id == auth()->user()->id)
                                                                ...
                                                                @else
                                                                    <td>
                                                                        <a class="modal-effect btn btn-sm btn-warning"  href="{{ route('showLaboratory' , $patient_Laboratorie->id) }}"><i class="fas fa-binoculars"></i></a>
                                                                    </td>
