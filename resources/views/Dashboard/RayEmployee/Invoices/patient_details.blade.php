...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('Dashboard/DoctorDashboard/Invoices.ray_images') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{$rays->patient->name}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    <div class="form-group">
        ...
        <textarea readonly class="form-control" id="exampleFormControlTextarea1" rows="3">{{$rays->employee_description}}</textarea>
    </div>
