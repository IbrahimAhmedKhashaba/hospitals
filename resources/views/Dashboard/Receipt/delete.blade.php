    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ trans('Dashboard/Receipts/Receipt.delete_receipt') }}</h5>
            ...
            <div class="modal-body">
                ...
                <h5>{{trans('Dashboard/Modals/Modal.delete_questions')}}<span style="color: red"> {{ $receipt->patients->name }}</span></h5>
            </div>
