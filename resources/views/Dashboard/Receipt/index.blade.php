...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('main-sidebar_trans.accounts') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main-sidebar_trans.receipt_voucher') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('receipts.create')}}" class="btn btn-primary" role="button"
                                           aria-pressed="true">{{ trans('Dashboard/Receipts/Receipt.add_receipt') }}</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                           ...
                                           @foreach($receipts as $receipt)
                                               <tr>
                                                   ...
                                                   <td>
                                                       ...
                                                       <a href="{{route('receipts.show',$receipt->id)}}" class="btn btn-primary btn-sm" target="_blank"><i class="fas fa-print"></i></a>
