                ...
                <form action="{{route('patients.store')}}" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control fc-datepicker" name="date_birth"
                             type="text" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="gender"  value="{{old('gender')}}" class="form-control @error('gender') is-invalid @enderror" required>
                        </div>

                        <div class="col">
                            <label>{{ trans('Dashboard/Tables/Table.blood_type') }}</label>
                            <input type="text" name="blood_type"  value="{{old('blood_type')}}" class="form-control @error('blood_type') is-invalid @enderror" required>
                        </div>
                    </div>
