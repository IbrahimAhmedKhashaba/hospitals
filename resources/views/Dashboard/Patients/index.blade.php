...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('main-sidebar_trans.patients') }}/</h4>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    <a href="{{route('patients.create')}}" class="btn btn-primary">{{ trans('Dashboard/Patients/Patient.add_patient') }}</a>
								</div>
							</div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th>{{ trans('Dashboard/Tables/Table.address') }}</th>
